...
var format_LineasSismicas_1 = new ol.format.GeoJSON();
var features_LineasSismicas_1 = format_LineasSismicas_1.readFeatures(json_LineasSismicas_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LineasSismicas_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LineasSismicas_1.addFeatures(features_LineasSismicas_1);
var lyr_LineasSismicas_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_LineasSismicas_1, 
                style: style_LineasSismicas_1,
                popuplayertitle: "LineasSismicas",
                interactive: true,
                title: '<img src="styles/legend/LineasSismicas_1.png" /> LineasSismicas'
            });
...
var format_rios_princ_4 = new ol.format.GeoJSON();
var features_rios_princ_4 = format_rios_princ_4.readFeatures(json_rios_princ_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_rios_princ_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_rios_princ_4.addFeatures(features_rios_princ_4);
var lyr_rios_princ_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_rios_princ_4, 
                style: style_rios_princ_4,
                popuplayertitle: "rios_princ",
                interactive: true,
                title: '<img src="styles/legend/rios_princ_4.png" /> rios_princ'
            });

lyr_Bloques_0.setVisible(true);lyr_LineasSismicas_1.setVisible(true);lyr_mun_2.setVisible(true);lyr_pozos_3.setVisible(true);lyr_rios_princ_4.setVisible(true);
var layersList = [lyr_Bloques_0,lyr_LineasSismicas_1,lyr_mun_2,lyr_pozos_3,lyr_rios_princ_4];
...
lyr_rios_princ_4.set('fieldAliases', {'qc_id': 'qc_id', 'id_st': 'id_st', 'nombre': 'nombre', 'shape_len': 'shape_len', });
...
lyr_LineasSismicas_1.set('fieldImages', {'qc_id': '', 'objectid': '', 'object_key': '', 'survey_nam': '', 'line_name': '', 'company_ke': '', 'company_na': '', 'operator_k': '', 'operator_n': '', 'channel_nu': '', 'fold': '', 'line_lengt': '', 'arrang_typ': '', 'reg_time': '', 'sample_rat': '', 'max_offset': '', 'azimut': '', 'ano_adq': '', 'datum_key': '', 'recept_dis': '', 'shot_dis': '', 'datum': '', 'comment': '', 'tramo_line': '', 'punto_inic': '', 'punto_fina': '', 'update_dat': '', 'shape_leng': '', 'miniatura': '', });
...
lyr_rios_princ_4.set('fieldImages', {'qc_id': '', 'id_st': '', 'nombre': '', 'shape_len': '', });
...
lyr_LineasSismicas_1.set('fieldLabels', {'qc_id': 'no label', 'objectid': 'no label', 'object_key': 'no label', 'survey_nam': 'no label', 'line_name': 'no label', 'company_ke': 'no label', 'company_na': 'no label', 'operator_k': 'no label', 'operator_n': 'no label', 'channel_nu': 'no label', 'fold': 'no label', 'line_lengt': 'no label', 'arrang_typ': 'no label', 'reg_time': 'no label', 'sample_rat': 'no label', 'max_offset': 'no label', 'azimut': 'no label', 'ano_adq': 'no label', 'datum_key': 'no label', 'recept_dis': 'no label', 'shot_dis': 'no label', 'datum': 'no label', 'comment': 'no label', 'tramo_line': 'no label', 'punto_inic': 'no label', 'punto_fina': 'no label', 'update_dat': 'no label', 'shape_leng': 'no label', 'miniatura': 'no label', });
...
lyr_rios_princ_4.set('fieldLabels', {'qc_id': 'no label', 'id_st': 'no label', 'nombre': 'no label', 'shape_len': 'no label', });
lyr_rios_princ_4.on('precompose', function(evt) {
